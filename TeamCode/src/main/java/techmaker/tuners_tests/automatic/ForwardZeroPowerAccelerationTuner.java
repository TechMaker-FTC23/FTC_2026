package techmaker.tuners_tests.automatic;
...
public class ForwardZeroPowerAccelerationTuner extends OpMode {
    ...
    public void loop() {
        ...
        if (!end) {
            if (!stopping) {
                telemetryA.addData("Velocity X",poseUpdater.getVelocity().getXComponent());
                telemetryA.addData("Velocity Y",poseUpdater.getVelocity().getYComponent());
                telemetryA.addData("Heading X",heading.getXComponent());
                telemetryA.addData("Heading Y",heading.getYComponent());
                telemetryA.addData("Total",MathFunctions.dotProduct(poseUpdater.getVelocity(), heading));
                telemetryA.update();
